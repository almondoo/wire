...
モックされた依存関係を持つ注入されたアプリを作成するには、2つのアプローチがあります。両方のアプローチの例は[こちら](https://github.com/google/wire/tree/main/internal/wire/testdata/ExampleWithMocks/foo)で示されています。
